...
public class FP01 {
     /*
       ...
       We can not use functional programming with maps,
       but we can convert Maps to Collection by using entrySet() method and we can use functional programming.
     */
    public static void main(String[] args) {
        ...
        printElementsStructured(l);  // 8 9 131 10 9 10 2 8 15
        System.out.println();
        ...
        System.out.println();
        printCubeOfDistinctElements(l); // 729 2248091 3375
        System.out.println();
        getMaxElement01(l); // 131
        getMaxElement02(l); // 131
        getMinimumEvenGreaterThanSeven01(l); // 8
        getMinimumEvenGreaterThanSeven02(l); // 8
        getMinimumEvenGreaterThanSeven03(l); // 8
        halfOfDistinctElementsGreaterThanFive(l); // [65.5, 7.5, 5.0, 4.5, 4.0]
        System.out.println();
