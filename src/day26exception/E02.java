...
public class E02 {
    ...
    public static void main(String[] args) {
        ...
        getAnElementFromAnArray(arr, 3);  // Han
        getAnElementFromAnArray(arr, 1);  // Can
        getAnElementFromAnArray(arr, 4);  // ArrayIndexOutOfBoundsException ==> Index 4 out of bounds for length 4
        getAnElementFromAnArray(arr, 5);  // ArrayIndexOutOfBoundsException ==> Index 5 out of bounds for length 4
    }
