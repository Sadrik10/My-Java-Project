...
class Runner{
    ...
    public static void main(String[] args) {
        ...
        System.out.println(obj2.a);   // 13 ==> If a class does not have "a", Java looks for "a" in parent classes.
                                     //   ****  If any parent does not have "a", you will get Compile Time Error  ****
        obj2.rest();                // ZZZ
