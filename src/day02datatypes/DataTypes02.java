...
public class DataTypes02 {
    ...
    public static void main(String[] args) {
        ...
        // Note: If you use any char in an mathematical operation, Java uses its ASCII value in the operation
        ...
        // Type code to find th sum of the ASCII Values of 'X' and 'y' and '?'
        char c1 = 'X', c2 = 'y', c3 ='?';
        System.out.println(c1 + c2 + c3); // 272

        // Create 3 integer variable characters whose values are 5 and 2 then print the result of first is divided by second
        ...
        System.out.println(2 + 'a' + "B" + (3 + 4)); // ( 2 + (a=97) + B +(3 + 4) = 99B7
