...
public class DateTime01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LocalDate.now().plusDays(200));  // 2022-09-19
        System.out.println(LocalDate.now().plusMonths(25)); // 2024-04-03

        // How to get past dates
        System.out.println(LocalDate.now().minusWeeks(7)); // 2022-01-13
        System.out.println(LocalDate.now().plusYears(2).minusWeeks(5));  // 2024-01-28
