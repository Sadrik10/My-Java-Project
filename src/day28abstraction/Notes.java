...
public class Notes {
       ...
       5) An abstract class have abstract child classes. It is not mandatory for "abstract child classes" to override "abstract methods"
          from parent class.
       6) Abstract methods can not be final because abstract methods will have newly updated body in every child class
          but final method means no update in the body.
