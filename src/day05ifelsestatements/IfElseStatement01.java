...
public class IfElseStatement01 {
    ...
    public static void main(String[] args) {
        ...
        //Note: in java there is OR operator ||

        //When you use OR operator if one is true, the result will be true
        //If you user enters the day names in different cases monday-MonDaY, we can not see anything on the console
        ...
        //Make if statement parenthesis shorter
